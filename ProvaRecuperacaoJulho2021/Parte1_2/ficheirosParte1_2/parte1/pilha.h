...
*   este registo contem um inteiro
...
/**
 *  \brief retorna o elemento armazenado no topo da pilha - proximo elemento a sair/ultimo elemento que entrou
 *  \param l apontador para a pilha
 *  \return apontador para o elemento no topo da pilha
 */
