/*****************************************************************/
/*      Biblioteca lista ligada | PROG2 | MIEEC | 2020/21        */
/*****************************************************************/
 ...
 *  parametro: count contagem a inserir
 ...
 */
l_elemento* lista_insere(lista *lst, const char* valor, int count, l_elemento *pos);
...
/**
*  atribui o valor e contagem especificados a um elemento da lista
*  parametro: lst apontador para a lista
*  parametro: pos elemento onde colocar valor
*  parametro: str nova string pretendida
*  parametro: count nova contagem pretendida
*  retorno: -1 se ocorrer algum erro (p.ex. se valor pos indicar uma posicao invalida) ou pos se bem sucedido
*/
int lista_atribui(lista *lst, l_elemento *pos, const char* str, int count);
