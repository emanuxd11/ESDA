...
*   este registo contem um apontador para uma pilha de contentores
*   e um apontador para o proximo elemento da fila
*/
...
/** 
 *  \brief elimina uma fila, libertando toda a memoria ocupada
