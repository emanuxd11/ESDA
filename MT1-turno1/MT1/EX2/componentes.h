...
/*
*  remove da fatura a parcela com o ID dado
*  parametro f - apontador para a fatura
*  parametro id - id da parcela a remover
*  retorno:  apontador para a parcela removida da fatura ou NULL se ocorrer um erro (ou a parcela nao existir na fatura).
*/

parcela  *parcela_remove(fatura *f, const char *ID);
